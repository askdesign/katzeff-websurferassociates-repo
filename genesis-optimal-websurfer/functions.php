...
function genesis_sample_google_fonts() {
	wp_enqueue_style( 'google-font', '//fonts.googleapis.com/css?family=Rosario|Vollkorn', array(), PARENT_THEME_VERSION );
}
...
// Add support for custom header - eliminate this
...
function custom_footer_creds_text() {
    ...
    echo 'Copyright &copy; ';
    echo date('Y');
 	echo ' &middot; <a href="https://appfinite.com/shop/optimal/">Optimal Theme</a> &middot; Built on the WordPress 
